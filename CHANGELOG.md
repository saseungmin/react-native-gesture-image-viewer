...
- [#197](https://github.com/saseungmin/react-native-gesture-image-viewer/pull/197) [`758aa2f`](https://github.com/saseungmin/react-native-gesture-image-viewer/commit/758aa2fd7a9a731e1c55df5b1855f32dcac7907f) Thanks [@saseungmin](https://github.com/saseungmin)! - Fix focal-point drift when a pinch settles back to `maxZoomScale`, while respecting the rendered content bounds. Keep scale and translation animations synchronized throughout the return.

## 2.5.0

### Minor Changes

- [#195](https://github.com/saseungmin/react-native-gesture-image-viewer/pull/195) [`cfc2217`](https://github.com/saseungmin/react-native-gesture-image-viewer/commit/cfc2217a00f02cffce303e9a851ef1c5202a089b) Thanks [@saseungmin](https://github.com/saseungmin)! - Clamp zoom and pan bounds to the rendered content rect for `contain`-fitted items. Content
...
- [#182](https://github.com/saseungmin/react-native-gesture-image-viewer/pull/182) [`d7981fb`](https://github.com/saseungmin/react-native-gesture-image-viewer/commit/d7981fbf91203dcd2388ad43de59903e0c3f6d5c) Thanks [@saseungmin](https://github.com/saseungmin)! - Expose the settled active list item through the third `renderItem` argument.
