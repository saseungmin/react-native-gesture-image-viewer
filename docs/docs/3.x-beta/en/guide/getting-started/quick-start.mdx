...
- [🤖 Expo Go](https://snack.expo.dev/@harang/react-native-gesture-image-viewer-v3) - Try it instantly on Expo Snack
...
Therefore, you **must install** React Native Reanimated and Gesture Handler before using this library. **If you haven't set it up yet, please refer to the [installation guide](/3.x-beta/guide/getting-started/installation.html).**
:::
...
:::tip Accurate bounds for `contain` content
...
[item dimensions guide](/3.x-beta/guide/usage/item-dimensions.html).
:::
