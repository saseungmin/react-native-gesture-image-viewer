...
When your image data already includes natural dimensions, pass them with `getItemDimensions`. It avoids extra layout measurement and keeps zoom/pan bounds accurate for `contain` images.
