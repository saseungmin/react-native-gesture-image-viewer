...
따라서 이 라이브러리를 사용하기 전에 React Native Reanimated와 Gesture Handler를 설치해야 합니다. **아직 설정을 하지 않았다면 [설치 가이드](/ko/guide/getting-started/installation.html)를 참고해주세요.**
:::
...
[콘텐츠 크기 가이드](/ko/guide/usage/item-dimensions.html)를 참고하세요.
:::
