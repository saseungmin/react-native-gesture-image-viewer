...
To understand how paging has changed, see [How v3 Paging Works](/guide/getting-started/overview.html#how-v3-paging-works) in the overview. It explains which pages are rendered and how the render window updates during page transitions, with an illustration.
