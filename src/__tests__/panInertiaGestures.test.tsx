...
describe('zoom pan inertia integration', () => {
  ...
  async function setup(panInertia: GestureViewerProps<string, unknown>['panInertia'] = true) {
    ...
    const pinch = hook.result.current.zoomGesture
      .toGestureArray()
      .find((g) => g.handlerName === 'PinchGestureHandler') as ReturnType<typeof Gesture.Pinch>;
    await act(() => {
